...
export declare class UnifiedNumberFormat implements Omit<Intl.NumberFormat, 'formatToParts'> {
    private pl;
    ...
    static __addLocaleData(...data: RawNumberLocaleData[]): void;
...
export declare type UnifiedNumberFormatPartTypes = Intl.NumberFormatPartTypes | 'exponentSeparator' | 'exponentMinusSign' | 'exponentInteger' | 'compact' | 'unit';
